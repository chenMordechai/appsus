...
function addingBookFromGoogle(book) {
  var books = storageService.load(BOOKS_KEY);
  console.log('in book service adding google book befor', books)
  console.log('the curr book', book)
  var newBook = {
    id: book.id,
    title: (book.volumeInfo.title) ? book.volumeInfo.title : "Kofifo",
    subtitle: (book.volumeInfo.subtitle) ? book.volumeInfo.subtitle : 'kofifo in the big city',
    authors: (book.volumeInfo.authors) ? book.volumeInfo.authors : "Moshe Ben David",
    reviews: [],
    publishedDate: (book.volumeInfo.publishedDate) ? book.volumeInfo.publishedDate : 1997,
    description: (book.volumeInfo.description) ? book.volumeInfo.description : "auctor amet nostra luctus molestie proin platea cubilia netus sed purus egestas a primis eu tristique interdum litora lorem venenatis mattis senectus",
    pageCount: (book.volumeInfo.pageCount) ? book.volumeInfo.pageCount : 258,
    categories: (book.volumeInfo.categories) ? book.volumeInfo.categories : ["Computers", "Hack"],
    thumbnail: book.volumeInfo.imageLinks.thumbnail,
    language: (book.volumeInfo.language) ? book.volumeInfo.language : "sp",
    listPrice: {
      amount: 100,
      currencyCode: "ILS",
      isOnSale: false
  ...
  console.log('in book service adding google book after', booksDB)
